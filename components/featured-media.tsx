...
export default async function FeaturedMedia() {
  ...
  // Get the top 5 trending items
  const top5Trending = trending.results.slice(0, 5)
  ...
  return (
    ...
    >
      <CarouselContent className="h-[500px] md:h-[600px] lg:h-[700px]">
        {top5Trending.map((featured, index) => {
          ...
          return (
            <CarouselItem key={featured.id} className="relative">
